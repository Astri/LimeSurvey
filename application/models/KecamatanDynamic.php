 ...
 * @property DesaDynamic[] $desas
 * @property KabupatenDynamic $kabupaten
 */
class KecamatanDynamic extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'desas' => array(self::HAS_MANY, 'DesaDynamic', 'kecamatanid'),
			'kabupaten' => array(self::BELONGS_TO, 'KabupatenDynamic', 'kabupatenid'),
		);
	}
