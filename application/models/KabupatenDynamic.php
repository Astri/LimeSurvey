 ...
 * @property ProvinsiDynamic $provinsi
 * @property KecamatanDynamic[] $kecamatans
 */
class KabupatenDynamic extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'provinsi' => array(self::BELONGS_TO, 'ProvinsiDynamic', 'provinsiid'),
			'kecamatans' => array(self::HAS_MANY, 'KecamatanDynamic', 'kabupatenid'),
		);
	}
